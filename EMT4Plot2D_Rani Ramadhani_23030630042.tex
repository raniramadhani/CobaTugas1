...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-001.png}
\begin{eulerprompt}
>reset;
\end{eulerprompt}
\begin{eulercomment}
...
>plot2d("x^4-x",grid=6):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-002.png}
\begin{eulerprompt}
>hold off;
>window(ow);
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D_Rani Ramadhani_23030630042-003.png}
\begin{eulerprompt}
>aspect();
>reset;
\end{eulerprompt}
...
>plot2d("x^2"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-004.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-005.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 25 baris
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-006.png}
\begin{eulercomment}
...
>plot2d("x^3-x",-1,2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-007.png}
\begin{eulerprompt}
>plot2d("sin(x)",-2*pi,2*pi): // plot sin(x) pada interval [-2pi, 2pi]
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-008.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(3*x)",xmin=0,xmax=2pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-009.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-010.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-012.png}
\begin{eulerprompt}
>plot2d("sin(x)+cos(2*x)",0,4pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-014.png}
\begin{eulerprompt}
>plot2d("x^x",r=1.2,cx=1,cy=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-015.png}
\begin{eulercomment}
...
>plot2d("log(x)",-0.1,2):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-016.png}
\begin{eulercomment}
...
>plot2d("x^3-x",>square):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-017.png}
\begin{eulerprompt}
>plot2d(''integrate("sin(x)*exp(-x^2)",0,x)'',0,2): // plot integral
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-020.png}
\begin{eulerprompt}
>a:=5.6; expr &= exp(-a*x^2)/a; // define expression
>plot2d(expr,-2,2): // plot from -2 to 2
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-021.png}
\begin{eulerprompt}
>plot2d(expr,r=1,thickness=2): // plot in a square around (0,0)
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-022.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),>add,style="--",color=red): // add another plot
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-023.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x,2),a=-2,b=2,c=-2,d=1): // plot in rectangle
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-024.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),a=-2,b=2,>square): // keep plot square
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-025.png}
\begin{eulerprompt}
>plot2d("x^2",0,1,steps=1,color=red,n=10):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-026.png}
\begin{eulerprompt}
>plot2d("x^2",>add,steps=2,color=blue,n=10):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-027.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-028.png}
\begin{eulerprompt}
>plot2d("f",0,1;0.4): // plot with a=0.4
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-029.png}
\begin{eulerprompt}
>plot2d(\{\{"f",0.2\}\},0,1): // plot with a=0.2
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-030.png}
\begin{eulerprompt}
>plot2d(\{\{"f(x,b)",b=0.1\}\},0,1): // plot with 0.1
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-031.png}
\begin{eulerprompt}
>function f(x) := x^3-x; ...
>plot2d("f",r=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-032.png}
\begin{eulercomment}
...
>plot2d(f,0,2):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-033.png}
\begin{eulercomment}
...
>plot2d(expr,0,3pi):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-034.png}
\begin{eulerprompt}
>function f(x) &= x^x;
>plot2d(f,r=1,cx=1,cy=1,color=blue,thickness=2);
>plot2d(&diff(f(x),x),>add,color=red,style="-.-"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D_Rani Ramadhani_23030630042-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D_Rani Ramadhani_23030630042-038.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rani Ramadhani_23030630042-039.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("sin(x)",0,2pi); plot2d("cos(x)",color=blue,style="--",>add):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-044.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-045.png}
\begin{eulercomment}
...
>plot2d(x,y):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-048.png}
\begin{eulerprompt}
>plot2d(["sin(x)","cos(x)"],0,2pi): // plot vector of expressions
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-049.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-051.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-054.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-055.png}
\begin{eulerprompt}
>expr := "log(x)/x"; ...
>  plot2d(expr,0.5,5,title="y="+expr,xl="x",yl="y"); ...
>  label("(1,0)",1,0); label("Max",E,expr(E),pos="lc"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-056.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-057.png}
\begin{eulercomment}
...
>tcolor=black,>left):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rani Ramadhani_23030630042-058.png}
\begin{eulercomment}
